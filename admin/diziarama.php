...
if (isset($_POST['gonder'])) {
    ...
    $sql = "SELECT * FROM diziler WHERE dizi_adi LIKE '%$arama%' OR dizi_tur LIKE '%$arama%' OR dizi_yonetmen LIKE '%$arama%' OR dizi_cikis LIKE '%$arama%'";
    ...
    if ($veri == 0) {
        echo "<script>alert('Dizi Bulunamadı'); window.location.href='dizileradmin.php';</script>";
    } else {
?>
        <!DOCTYPE html>
        <html lang="tr">
