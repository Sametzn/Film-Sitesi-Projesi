...
<body>
    ...
    <main>
        <form action="dizidetay.php" method="post" enctype="multipart/form-data">
            <div class="container ">
                <div class="row mt-4">
                    <div class="col">
                        <div class="row row-cols-1 row-cols-md-2 g-4">
                            <div class="col">
                                <div class="card">
                                    <?php echo "<img src='../images/" . $satir["dizi_resim"] . "'>"; ?>
                                    <div class="card-body">
                                        <h5 class="card-title"><?= $satir['dizi_adi'] ?></h5>
                                        <p class="card-text"><?= $satir['dizi_aciklama'] ?></p>
                                        <ul class="list-group list-group-flush">
                                            <li class="list-group-item">Çıkış Tarihi: <?= $satir['dizi_cikis'] ?></li>
                                            <li class="list-group-item">Yönetmen:<?= $satir['dizi_yonetmen'] ?></li>
