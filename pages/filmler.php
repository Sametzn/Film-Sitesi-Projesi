...
$sql = "SELECT * FROM filmler1";
$all_filmler = $baglanti->query($sql);
?>
...
<body>
    ...
    <main>
        <div class="container">
            ...
            while ($satir = mysqli_fetch_assoc($all_filmler)) {
                if ($counter % 6 == 0) {
            ...
            ?>
                <li class="movie-item">
                    <img class="movie-item-img" src="../images/<?php echo $satir["film_resim"] ?>" alt="<?php echo $satir["film_adi"] ?>">
                    <div class="movie-item-info">
                        <span class="movie-item-title"><?php echo $satir["film_adi"] ?></span>
                        <div class="movie-item-buttons">
                            <a href="../info/info.php?film_id=<?php echo $satir['film_id']; ?>"><i style="color: #adbac7;" class="bi bi-play-circle-fill"></i></a>
