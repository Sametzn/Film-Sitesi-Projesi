    ...
    <div class="navbar">
        <div class="navbar-wrapper">
            ...
            <div class="menu-container">
                <ul class="menu-list">
                    <li><a class="menu-list-item " href="homepage.php">Ana Sayfa</a></li>
                    <li><a class="menu-list-item" href="filmler.php">Filmler</a></li>
                    <li><a class="menu-list-item" href="diziler.php">Diziler</a></li>
            ...
            <div class="profile-container">
                <div class="profile-text-container">
                    ...
                    if (isset($_SESSION['user_id'])) {
                        echo '<a class="cikis" href="cikis.php">
                    <i class="bi bi-box-arrow-left"></i>
                    <div>Çıkış Yap</div>
                  </a>';
                    } else {
                        echo '<a class="kayıt" href="../login/kayit.php">
                        <i class="fa-solid fa-user-plus"></i>
                        <div >Kayıt Ol</div>
                    </a>';
                        echo '<a class="giris" href="../login/login.php">
        ...
        <div class="content-wrapper">
            <div class="featured-content" style="background-image: url(../images/d611ec500a3c282377031f6e87663186.jpg);">
                ...
                <p class="featured-desc">Avengers: Sonsuzluk Savaşı, dünyanın gördüğü en büyük tehdite karşı güçlerini birleştirmek
                    ...
                    olayların ardından bölünen kahramanlarımız, birbirlerinden uzaklara savrulurlar. Hepsi kendi yandaşlarıyla
                    dünyayı korumaya çalışmaktadır. Ancak dünyanın kaderi bir kez daha tehlikeye girer. Sınırsız bir güç kaynağı
                    olan sonsuzluk taşlarının peşine düşen Thanos, dünyanın gördüğü en büyük tehdittir. İnsanlığın kaderi bir kez daha,
                    insanlık için savaşmaya ant içmiş kahramanlarımız elindedir. Hiçbir süper kahramanın tek başına yenemeyeceği
                    büyüklükteki bu tehdit için ekipler birleşmeli ve tehdide tüm güçleriyle karşı koymalıdır...</p>
